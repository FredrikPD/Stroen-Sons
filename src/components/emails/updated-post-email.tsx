...
interface UpdatedPostEmailProps {
    postTitle: string;
    postContent: string;
    authorName: string;
    postUrl: string;
...
export const UpdatedPostEmail = ({
    postTitle = "Oppdatert innlegg",
    postContent = "Det har kommet en oppdatering på Strøen Søns.",
    authorName = "Styret",
    postUrl = "https://stroen-sons.com/posts",
    category = "NYHET",
}: UpdatedPostEmailProps) => {
    ...
    return (
        <Html>
            <Head />
            <Preview>Oppdatert innlegg: {postTitle}</Preview>
            <Tailwind>
                    ...
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px] bg-white">
                        <Section className="mt-[32px]">
                            <Heading className="text-gray-900 text-[24px] font-normal text-center p-0 my-[30px] mx-0">
                                Oppdatert innlegg på <strong>Strøen Søns</strong>
                            </Heading>
                        </Section>
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">
                            {authorName} har oppdatert innlegget i kategorien <strong>{category}</strong>:
                        </Text>
...
export default UpdatedPostEmail;
