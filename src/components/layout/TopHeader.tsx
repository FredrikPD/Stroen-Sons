...
export default function TopHeader({
  ...
  return (
    <header className="sticky top-0 h-[calc(3.5rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] border-b border-border-color bg-background-header flex items-center justify-between px-4 sm:px-6 lg:px-10 shrink-0 z-20">
      {/* Left (Path) */}
